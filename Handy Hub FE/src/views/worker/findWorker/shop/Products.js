...
const ProductsPage = ({ addToCart, activeView, sidebarOpen, getCartItems, addToWishlist, setActiveView, deleteCartItem, setSidebarOpen, deleteWishlistItem }) => {
  // ** Redux Hooks
  const dispatch = useDispatch()
  const store = useSelector(state => state.store) || { products: [], params: { page: 1 }, totalProducts: 0 }

  // console.log('Redux Store:', store.products.length) // Debugging log
